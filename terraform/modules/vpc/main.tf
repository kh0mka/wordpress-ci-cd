...
resource "aws_subnet" "public" {
  ...
  vpc_id                                         = var.cidr == null ? var.public_vpc_id : local.vpc_id
...
resource "aws_route" "public_internet_gateway" {
  ...
  gateway_id             = var.public_gateway_id //aws_internet_gateway.this[0].id
...
resource "aws_subnet" "private" {
  ...
  vpc_id                                         = var.cidr == null ? var.private_vpc_id : local.vpc_id
...
resource "aws_internet_gateway" "this" {
  count = local.create_public_subnets && var.create_igw && var.cidr != null ? 1 : 0
